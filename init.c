...
void	data_init(t_all	*all_data, int map_width, int map_height)
{
	...
	all_data->win_ptr = mlx_new_window(all_data->mlx_ptr, map_width * TILE_BIT, map_height * TILE_BIT, "junglee");
	...
	all_data->collectible.img = mlx_xpm_file_to_image(all_data->mlx_ptr, "./Sprites/tileset/coin.xpm", \
