...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   player_right_sprite_init.c                         :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: junglee <junglee@student.42.fr>            +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/15 20:42:59 by junglee           #+#    #+#             */
/*   Updated: 2023/02/17 15:32:41 by junglee          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	player_right_sprite_init(t_all *all_data)
{
	...
	collect_right_sprtie(&all_data->player, all_data->mlx_ptr);
}
